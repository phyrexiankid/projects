	...
	public void AdColony_ShowVideoForV4VC(String _a)
	{
	 ...
	 //Ad Started Callback - called only when an ad successfully starts playing
	  ...
	  public void onAdColonyAdAttemptFinished( AdColonyAd ad )
	  {
		...
		RunnerJNILib.DsMapAddDouble(dsmapindex,"shown", ad.shown()?1.0:0.0);
		RunnerJNILib.DsMapAddDouble(dsmapindex,"notshown",ad.notShown()?1.0:0.0);
		RunnerJNILib.DsMapAddDouble(dsmapindex,"skipped",ad.skipped()?1.0:0.0);
		RunnerJNILib.DsMapAddDouble(dsmapindex,"cancelled",ad.canceled()?1.0:0.0);
		RunnerJNILib.DsMapAddDouble(dsmapindex,"nofill",ad.noFill()?1.0:0.0);
